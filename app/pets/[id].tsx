...
import {
    ...
    NativeScrollEvent,
    Modal, // Componente Modal adicionado para tela cheia
} from "react-native";
...
// Obter as dimensões da janela para carrossel e modal
...
// =========================================================================
// ESTILOS (Ajustados para Transparência, Altura do Carrossel e Modal)
// =========================================================================

const styles = StyleSheet.create({
    safeArea: {
        flex: 1,
        // Cor alterada para transparente
    ...
    header: {
        ...
        // Cor alterada para transparente e fixado no topo
        backgroundColor: "transparent",
        position: "absolute",
        top: 0,
        left: 0,
...
const PetDetailsScreen = () => {
    ...
    // Estado para controlar a visibilidade e o URI da imagem em tela cheia
    const [fullscreenImageUri, setFullscreenImageUri] = useState<string | null>(null); 
    const [error, setError] = useState<string | null>(null);

    const scrollViewRef = useRef<ScrollView>(null);

    // Carregar dados do pet (mantido inalterado)
    useEffect(() => {
    ...
    // Função para tratar o scroll e atualizar o índice da imagem do carrossel
    ...
    // 🔧 ERROR STATE
    if (error || !pet) {
        // ... (Error state mantido inalterado)
        return (
            <SafeAreaView style={styles.safeArea}>
                <Stack.Screen options={{ headerShown: false }} />
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            ...
            >
                {/* --- CARROSSEL DE IMAGENS (Área aumentada) --- */}
