    ...
    const loadPetData = async () => {
      try {
        ...
        const processedPet: Pet = {
          ...
          images: Array.isArray(petData.images) && petData.images.length > 0 
            ? petData.images 
            : [petData.image || 'https://placehold.co/300x300/A0A0A0/FFFFFF?text=Sem+Foto'],
        ...
        const errorMessage = error instanceof Error ? error.message : 'Erro desconhecido ao carregar pet';
      ...
      >
        ...
        <View style={styles.contentContainer}>
          ...
          {!isOwnPet && owner && (
            <View style={styles.section}>
              ...
              <View style={styles.ownerCard}>
                <Image 
                  source={{ uri: owner.profileImage || 'https://placehold.co/50x50/A0A0A0/FFFFFF?text=Usuário' }} 
                  style={styles.ownerImage} 
                />
                <View style={styles.ownerInfo}>
                  <Text style={styles.ownerName}>{owner.username || 'Usuário'}</Text>
                  {owner.city && (
                    <View style={styles.ownerLocation}>
                      <Ionicons name="location" size={12} color="#666" />
                      <Text style={{ marginLeft: 4, fontSize: moderateScale(12), color: '#666' }}>
          ...
          <View style={styles.section}>
            ...
            <View style={[styles.characteristicItem, styles.characteristicItem_last]}>
              <View style={styles.characteristicIcon}>
