...
const RegisterPetScreen = () => {
  ...
  const { petId } = useLocalSearchParams(); // 🔧 RECEBER ID PARA EDIÇÃO
  ...
  // --- Efeito para Carregar Dados do Pet (se edição) ---
  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        router.replace("/my-applications" as never);
      }, 500);
    } catch (error: any) {
  ...
  const GenderOption: React.FC<{ label: Gender; icon: string }> = ({
    label,
    icon,
  }) => {
        ...
        <View style={styles.toggleButtonsCentered}>
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              {
                backgroundColor: getSimStyle(currentValue === true)
                  .backgroundColor,
          ...
          <TouchableOpacity
            style={[
              styles.toggleButton,
              {
                backgroundColor: getNaoStyle(currentValue === false)
                  .backgroundColor,
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {isEditing ? "Editar Pet" : "Cadastre seu pet!"}
        </Text>
      </View>
            ...
            <View style={styles.ageUnitSelector}>
              <TouchableOpacity
                style={[
                  ...
                  ageUnit === "anos" && styles.ageUnitButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.ageUnitText,
                    ageUnit === "anos" && styles.ageUnitTextActive,
                  ]}
                >
                  Anos
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.ageUnitButton,
                  ageUnit === "meses" && styles.ageUnitButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.ageUnitText,
                    ageUnit === "meses" && styles.ageUnitTextActive,
                  ]}
                >
                  Meses
                </Text>
